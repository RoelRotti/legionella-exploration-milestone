...
excel_file_path = 'output/ExportPDFToExcel/split_output.xlsx'  # Replace with the actual Excel file path
excel_file = pd.ExcelFile(excel_file_path)

df_assets = pd.DataFrame()

none_value_df_counter = 0
...
ONLY RETURN THE JSON, DO NOT RETURN ANYTHING ELSE.              """
    ...
    if assetsGPT:
        ...
        try:
            ...
            # Create the output directory if it doesn't exist
            output_dir = os.path.join("output", "ExcelToData")
...
df_assets.to_excel(os.path.join(output_dir, "assets_data.xlsx"), index=False)

print(f"Number of empty value dataframes: {none_value_df_counter}")
